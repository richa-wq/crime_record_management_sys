...
global conn,cursor
conn = mysql.connector.connect(host='localhost',database='crime',user='root',password='System#1')
cursor = conn.cursor()
...
def introduction():
    msg = '''
          C R I M E     R E C O R D    M A N A G E M E N T    S Y S T E M 
          
          - An Introduction
          
          Crime Record Mangement System is one the most important part of any modern society for better controlling crime. 
          Crime Record management system helps us to recognise the type of crime happeneing right now which helps us better maintain the records. 

          This project is also trying to solve this simply on command line interface. 
...
def made_by():
    msg = ''' 
            Crime Record information system made by     : Heeba H, Radhika N, Richa K, Varsha BR.
            USN's                                       : 1DS21CS405, 1DS21CS410, 1DS21CS412, 1DS21CS418
            College Name                                : Dayanand Sagar College of Engineering
            Session                                     : 2021-22
